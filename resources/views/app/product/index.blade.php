...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <x-data-table
            title="{{ __('All Product') }}"
            tableId="productTable"
            listUrl="{{ route('product.list') }}"
            :filters="[
                ['key' => 'name', 'label' => 'Name', 'type' => 'text'],
                ['key' => 'status', 'label' => 'Status', 'type' => 'enum', 'options' => ['success' => 'Success', 'pending' => 'Pending', 'failed' => 'Failed']],
...
function loadProductTable() {
    loadTableData('productTable', buildFilterUrl('productTable'), function(item) {
