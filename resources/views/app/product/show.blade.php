...
@section('title', $item->name ?? __('View Product'))

@php
    $topbarTitle = $item->name ?? __('View Product');
@endphp
...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 py-4">
          <dt class="text-sm font-medium text-gray-600 dark:text-gray-400">@lang('Name')</dt>
