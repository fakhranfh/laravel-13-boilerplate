...
@php
    $topbarTitle = 'Edit Permission';
@endphp

@section('app-content')
    <div class="max-w-2xl">
        <form action="{{ route('permissions.update', $permission) }}" method="POST" class="bg-surface border border-outline-variant rounded-lg p-space-lg space-y-space-lg">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center gap-space-md">
                ...
                <a href="{{ route('permissions.index') }}" class="font-label-md text-label-md text-secondary hover:underline">Cancel</a>
            </div>
        </form>
    </div>
@endsection
