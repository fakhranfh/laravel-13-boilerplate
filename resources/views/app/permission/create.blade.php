...
@php
    $topbarTitle = 'New Permission';
@endphp

@section('app-content')
    <div class="max-w-2xl">
        <form action="{{ route('permissions.store') }}" method="POST" class="bg-surface border border-outline-variant rounded-lg p-space-lg space-y-space-lg">
            @csrf
